...
export const resourceData = [
  {
    ...
    level: [LVL.ONE, LVL.TWO, LVL.THREE],
    topics: ["grammar"],
    reviews: []
  },
  {
  ...
  },
  {
    ...
    url: [
      {id: 0, url: "http://www.amazon.com/A-Dictionary-Basic-Japanese-Grammar/dp/4789004546", website_title: "Basic"},
      {id: 1, url: "http://www.amazon.com/Dictionary-Intermediate-Japanese-Grammar/dp/4789007758", website_title: "intermediate"},
      {id: 2, url: "http://www.amazon.com/Dictionary-Advanced-Japanese-Grammar/dp/4789012956", website_title: "Advanced"}
    ],
    cost: {
      hasCost: true,
      is_subscription: false,
  ...
  },
  {
    ...
    url: [
      {id: 0, url: "https://www.youtube.com/user/japaneseformorons", website_title: "Youtube"}
    ],
    cost: {
      hasCost: false,
      is_subscription: false,
  ...
  },
  {
    ...
    url: [
      ...
      {id: 1, url: "https://www.youtube.com/user/freejapaneselessons3", website_title: "YouTube"}
    ],
    cost: {
      hasCost: false,
      is_subscription: false,
  ...
  },
  {
    ...
    url: [
      {id: 0, url: "http://www.amazon.com/GENKI-Integrated-Elementary-Japanese-English/dp/4789014401", website_title: "Textbook"},
      {id: 1, url: "http://www.amazon.com/Genki-Integrated-Elementary-Japanese-Workbook/dp/478901441X", website_title: "Workbook"}
    ],
    cost: {
      hasCost: true,
      is_subscription: false,
  ...
  },
  {
    ...
    url: [
      {id: 0, url: "http://shop.whiterabbitjapan.com/products/nihongo-so-matome-jlpt-n3-5-book-set", website_title: "N3 5-Book Set"},
      {id: 1, url: "http://shop.whiterabbitjapan.com/products/nihongo-so-matome-jlpt-n2-5-book-set", website_title: "N2 5-Book Set"},
      {id: 2, url: "http://shop.whiterabbitjapan.com/products/nihongo-so-matome-jlpt-n1-5-book-set", website_title: "N1 5-Book Set"}
    ],
    cost: {
      hasCost: true,
      is_subscription: false,
  ...
  },
  {
    ...
    name: "Matcha",
    type: "website", //book, podcast, ...?
    description: "Travel magazine all in Japanese. All kanji has furigana so you'll know how to pronounce and look up all the words.",
    url: [
      {id: 0, url: "http://mcha-easy.com/", website_title: "Website"}
    ],
    cost: {
      hasCost: false,
      is_subscription: false,
    ...
    level: [LVL.TWO],
    topics: ["grammar", "vocabulary", "kanji", "practice"],
    reviews: []
  },
  {
    id: 26,
    name: "Okonomi Word",
    type: "website", //book, podcast, ...?
    description: "Study tool that helps you break down Japanese articles and create flash cards out of the words you don't know.",
    url: [
      {id: 0, url: "https://okonomiword.com/", website_title: "Website"}
    ],
    cost: {
      hasCost: true,
      is_subscription: true,
      price: "Free, but $2 subscription for more features",
      min: 0,
      max: 2
    },
    level: [LVL.TWO, LVL.THREE],
